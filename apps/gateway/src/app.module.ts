...
import { GatewayOrganizerShowsService } from './organizer/shows.service';
import { GatewayOrganizerOwnershipService } from './organizer/ownership.service';
...
import { GatewayOrganizerStatsService } from './organizer/stats.service';
import { GatewayOrganizerCheckInController } from './organizer/check-in.controller';
import { GatewayOrganizerCheckInService } from './organizer/check-in.service';
...
@Module({
  ...
  providers: [
    ...
    GatewayOrganizerCheckInService,
  ],
})
