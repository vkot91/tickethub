...
export class NotifyController {
  ...
  // Tickets → ticket.pdf_ready. Its own queue + DLX so a delivery that keeps failing
  ...
  @RabbitSubscribe(eventSub(TICKET_ROUTING_KEYS.TICKET_PDF_READY, EVENTS_QUEUES.TICKETS_PDF_READY))
