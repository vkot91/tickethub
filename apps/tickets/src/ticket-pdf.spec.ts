...
describe('renderTicketPdf', () => {
  ...
  // The standard WinAnsi fonts throw on any character outside Latin-1, so a show title or seat
  // label with non-Latin script must not take the whole PDF render down with it.
