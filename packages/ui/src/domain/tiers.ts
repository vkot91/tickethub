 ...
 * it comes off the price band covering the seat's section, alongside the `priceCents` orders
...
/** A seat no price band covers is not on sale; it renders neutral rather than borrowing a
